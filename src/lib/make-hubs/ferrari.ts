...
export const FERRARI_HUB = {
  make: "Ferrari",
  slug: "ferrari",
  title: "Ferrari for Sale from Japan | Best Models to Buy",
  description:
    "The best Ferrari to buy from Japan — 308, 328, F355, 360 Modena, 458 Italia, Testarossa, 512 TR and F12 Berlinetta. Browse stock or ask ZervTek to source and export.",
  h1: "Best Ferrari to Buy",
  lead: [
...
export function ferrariStockHref(model?: string): string {
  const params = new URLSearchParams({ make: "Ferrari" });
